      ...
      <div class="row">
        <div class="col-md-12">
          <div class="jumbotron">
            ...
            <p><a class="btn btn-primary btn-lg" href="{{url('posts')}}" role="button">All Post</a></p>
            <p><a class="btn btn-primary btn-lg" href="{{ url('posts/create')}}" role="button">Create New Post</a></p>
          </div>
        </div>
      </div>
      <!-- end of header .row -->
